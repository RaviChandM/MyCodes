...
def nearest_strike_fnf(x): return round_nearest(x,50)
...
print_hr()
print_header("Fin Nifty",fnf_ul,fnf_nearest)
print_hr()
print_oi(10,50,fnf_nearest,url_fnf)
print_hr()
...
# Finding Highest OI in Call Option In FIN Nifty
fnf_highestoi_CE = highest_oi_CE(10,50,fnf_nearest,url_fnf)
